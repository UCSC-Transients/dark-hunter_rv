...
| Lane | Steps | Status |
|------|-------|--------|
| **mask_ccf** | 01, 02a, 09 | `subchunks_8` on main; **bias rebuild deferred** ([#57](https://github.com/UCSC-Transients/dark-hunter_rv/issues/57)) |
...
| **epoch_ccf** (relative) | 11 | **Complete** (opt-in enrich; default adopt declined) |
...
| 02 Chunk weights / subchunks | [steps/02-chunk-weights-subchunks.md](steps/02-chunk-weights-subchunks.md) | **02b done**; **bias rebuild open** | [#39](https://github.com/UCSC-Transients/dark-hunter_rv/issues/39), [#57](https://github.com/UCSC-Transients/dark-hunter_rv/issues/57) | `step/02b-trust-weights-stack` | 2026-08-02 ([#95](https://github.com/UCSC-Transients/dark-hunter_rv/pull/95)/[#99](https://github.com/UCSC-Transients/dark-hunter_rv/pull/99) → [#101](https://github.com/UCSC-Transients/dark-hunter_rv/pull/101)) |
...
| 08 External RV cross-check | [steps/08-external-rv-crosscheck.md](steps/08-external-rv-crosscheck.md) | **complete** (waived n=8) | [#45](https://github.com/UCSC-Transients/dark-hunter_rv/issues/45) closed | — | 2026-08-02 ([#96](https://github.com/UCSC-Transients/dark-hunter_rv/pull/96)/[#104](https://github.com/UCSC-Transients/dark-hunter_rv/pull/104)) |
...
| 11 Epoch–epoch CCF matrix | [steps/11-epoch-ccf-matrix.md](steps/11-epoch-ccf-matrix.md) | **complete** (opt-in; no default adopt) | [#94](https://github.com/UCSC-Transients/dark-hunter_rv/issues/94) closed | — | 2026-08-02 ([#95](https://github.com/UCSC-Transients/dark-hunter_rv/pull/95)/[#98](https://github.com/UCSC-Transients/dark-hunter_rv/pull/98)/[#103](https://github.com/UCSC-Transients/dark-hunter_rv/pull/103)) |
