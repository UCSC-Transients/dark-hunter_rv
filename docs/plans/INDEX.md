...
| 08 External RV cross-check | [steps/08-external-rv-crosscheck.md](steps/08-external-rv-crosscheck.md) | in_progress (lite done; **full in flight**) | [#45](https://github.com/UCSC-Transients/dark-hunter_rv/issues/45) | `step/08-external-rv-crosscheck`, `step/08-external-rv-full` | lite local `a6ffe75` |
