...
| 02 Chunk weights / subchunks | [steps/02-chunk-weights-subchunks.md](steps/02-chunk-weights-subchunks.md) | in_progress (**02b local done** opt-in; campaign A/B residual; 02a deferred) | [#39](https://github.com/UCSC-Transients/dark-hunter_rv/issues/39) | `step/02a-bias-defer-verify`, `step/02b-trust-weights-stack` | 02b local `f0400f9` |
...
| 07 SB2 search | [steps/07-sb2-search.md](steps/07-sb2-search.md) | in_progress (07a/b local; NSS table + pipeline fuse residual) | [#44](https://github.com/UCSC-Transients/dark-hunter_rv/issues/44) | `step/07-sb2-search` | local `7129124` |
| 08 External RV cross-check | [steps/08-external-rv-crosscheck.md](steps/08-external-rv-crosscheck.md) | **complete PARTIAL** (CLI ready; n_lit=4 need ≥10) | [#45](https://github.com/UCSC-Transients/dark-hunter_rv/issues/45) | `step/08-external-rv-crosscheck`, `step/08-external-rv-full` | lite `a6ffe75`; full `fec76dc` |
