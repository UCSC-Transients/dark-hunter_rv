...
| **epoch_ccf** (relative) | 11 | **11a–d enrich on main (PR pending)**; default adopt still human gate ([#94](https://github.com/UCSC-Transients/dark-hunter_rv/issues/94)) |
...
| 07 SB2 search | [steps/07-sb2-search.md](steps/07-sb2-search.md) | in_progress (fuse+NSS CLI on main; **NSS dump 147/155** in soft-residuals-3; flag rates need refit) | [#44](https://github.com/UCSC-Transients/dark-hunter_rv/issues/44) | `phase/soft-residuals-3` | 2026-08-02 ([#99](https://github.com/UCSC-Transients/dark-hunter_rv/pull/99)/[#103](https://github.com/UCSC-Transients/dark-hunter_rv/pull/103) → main) |
| 08 External RV cross-check | [steps/08-external-rv-crosscheck.md](steps/08-external-rv-crosscheck.md) | **complete PARTIAL** (CLI on main; **n_stars=8** max w/ current spectra∩master; ≥10 needs ingest) | [#45](https://github.com/UCSC-Transients/dark-hunter_rv/issues/45) | `step/08-external-rv-crosscheck`, `phase/soft-residuals-2` | 2026-08-02 ([#96](https://github.com/UCSC-Transients/dark-hunter_rv/pull/96)/[#99](https://github.com/UCSC-Transients/dark-hunter_rv/pull/99)/[#103](https://github.com/UCSC-Transients/dark-hunter_rv/pull/103) → main) |
...
| 11 Epoch–epoch CCF matrix | [steps/11-epoch-ccf-matrix.md](steps/11-epoch-ccf-matrix.md) | in_progress (11a–c on main; **11d enrich hook** in soft-residuals PR; default adopt open) | [#94](https://github.com/UCSC-Transients/dark-hunter_rv/issues/94) | `step/11-epoch-ccf-matrix`, `phase/soft-residuals` | 2026-08-02 ([#95](https://github.com/UCSC-Transients/dark-hunter_rv/pull/95)/[#98](https://github.com/UCSC-Transients/dark-hunter_rv/pull/98) → [#101](https://github.com/UCSC-Transients/dark-hunter_rv/pull/101)) |
