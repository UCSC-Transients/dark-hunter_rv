...
| 04 Adopted-RV match plots | [steps/04-adopted-rv-match-plots.md](steps/04-adopted-rv-match-plots.md) | in_progress | [#41](https://github.com/UCSC-Transients/dark-hunter_rv/issues/41) | `step/04-adopted-rv-match-plots` | — |
