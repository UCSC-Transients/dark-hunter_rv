...
| **strong_lines** | 06 | **Complete** (#43) — Hβ-primary on APF; Teff sweep done |
...
| 06 Strong-line line list | [steps/06-strong-line-line-list.md](steps/06-strong-line-line-list.md) | **complete** (Hβ-primary; API in #88) | [#43](https://github.com/UCSC-Transients/dark-hunter_rv/issues/43) | `step/06-strong-line-teff-sweep` | — |
